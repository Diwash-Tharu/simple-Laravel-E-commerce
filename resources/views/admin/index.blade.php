    ...
    <div class="mt-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
            ...
            <a href="{{url('categories')}}">
                <div class="p-2 rounded-md shadow-lg flex items-center justify-center transform hover:scale-115">
            ...
            <a href="{{url('users')}}">
                <div class="p-2 rounded-md shadow-lg flex items-center justify-center hover:scale-105">
                    <div class="flex flex-col items-center">
                        <img src="images/users_1251573.png" class="w-24 h-24 mb-4" alt="Categories Image">
