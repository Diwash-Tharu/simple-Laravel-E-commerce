        ...
        <div class="flex flex-wrap items-center justify-between -mx-4">
                ...
                <div class="flex items-center -mx-3 sm:-mx-4">
                    <div class="w-full px-3 sm:px-4 xl:w-1/2">
                        <div class="py-3 sm:py-4">
                            <img src="{{ asset('images/about1.jpg') }}" alt="" class="w-full rounded-2xl" />
                        </div>
                        <div class="py-3 sm:py-4">
                            <img src="{{ asset('images/about2.jpg') }}" alt="" class="w-full rounded-2xl" />
                        </div>
                    </div>
                    <div class="w-full px-3 sm:px-4 xl:w-1/2">
                        <div class="relative z-10 my-4">
                            <img src="{{ asset('images/about3.jpg') }}" alt="" class="w-full rounded-2xl" />
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="mt-10 lg:mt-0">
                    <span class="block mb-4 text-lg font-semibold text-teal-500">
                        Why Choose Us
                    </span>
                    <h2 class="mb-5 text-3xl font-bold text-dark dark:text-white sm:text-[40px]/[48px]">
                        Elevate Your Style with Trendy Outfits
                    </h2>
                    <p class="mb-5 text-base text-body-color dark:text-dark-6">
                        Discover the latest fashion trends and express your unique style. Our carefully curated
                        collection
                        ensures you stay ahead in the world of fashion.
                    </p>
                    <p class="mb-8 text-base text-body-color dark:text-dark-6">
                        At our clothing store, we believe that fashion is not just about clothing; it's about making a
                        statement.
                        Find the perfect outfits that reflect your personality and make you stand out from the crowd.
                    </p>
                    <a href="{{ url('/') }}"
                        class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-teal-600 hover:bg-opacity-90">
                        Explore Now
                    </a>
                </div>
            </div>
